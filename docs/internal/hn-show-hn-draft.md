...
**What we scanned:** We ran the OpenClaw Security Scan — 231 repos scanned successfully out of 2,007 discovered. The results: 14,350 total security findings. 98 critical findings across 20 repos. 6,192 high-severity. 8,045 medium-severity. Average trust score: 57.0/100 (Grade C). 32% of skills scored F (0-20). The top finding categories tell the story: filesystem access (8,239 findings), unsafe exec (5,871), data exfiltration patterns (146), hardcoded secrets (58), dependency vulnerabilities (29), obfuscation (7). Per-category sub-scores show exactly where the risk is: secret_hygiene, code_safety, data_handling, filesystem_access.
