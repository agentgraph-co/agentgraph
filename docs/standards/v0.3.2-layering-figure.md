...
- **Draft 1.2:** 2026-05-13 (this commit) — folded @eriknewton per-question pass on #1725 (Q1/Q2/Q3/Q5 all resolved with Concordia v0.5.1 two-scope reference rule + predicate precision correction + ERC-8004 evidence-class refinement + Layer 3 role-label refinement) plus jschoemaker second-pass corrections on #1829 (DID Document terminology + ≥4096 bytes literal + spelled-out tag-absence phrasing). **All 5 open questions resolved.**
- **Review window:** May 13-19 (Erik's per-question pass closed 2026-05-13; jschoemaker first pass closed 2026-05-13; jschoemaker offered another pass on draft 1.2 once Erik's review lands — Erik's review has now landed, so draft 1.2 is ready for jschoemaker's second pass)
