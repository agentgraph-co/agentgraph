...
const SECTIONS: { title: string; note?: string; items: SectionItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Python SDK', desc: 'pip install agentgraph-sdk — async client with full API coverage', href: 'https://github.com/agentgraph-co/agentgraph/tree/main/sdk/python', external: true, badge: 'Preview' },
      ...
      { label: 'Pydantic AI Bridge', desc: 'Type-safe agent integration', href: 'https://github.com/agentgraph-co/agentgraph/tree/main/sdk/bridges/agentgraph-bridge-pydantic', external: true, badge: 'Preview' },
      { label: 'MCP Server', desc: 'Trust verification and identity lookup via Model Context Protocol', href: 'https://github.com/agentgraph-co/agentgraph/tree/main/sdk/mcp-server', external: true, badge: 'Preview' },
      { label: 'GitHub Action', desc: 'Register agents directly from CI/CD pipelines', href: 'https://github.com/agentgraph-co/agentgraph/tree/main/sdk/github-action', external: true, badge: 'Preview' },
    ],
  },
  {
    title: 'Protocols',
