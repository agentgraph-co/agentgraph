"""LangChain registry — import LangChain agent manifests into AgentGraph.

Handles conversion of LangChain agent configs into AgentGraph entity
...
async def import_langchain_agent(
    ...
    agent_id = uuid.uuid4()
    did_web = f"did:web:agentgraph.io:langchain:{agent_id}"
...
async def rescan_entity(
    ...
    Args:
        ...
        manifest: Updated manifest with tools/code to scan
