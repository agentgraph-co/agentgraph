"""CrewAI registry — import CrewAI agent manifests into AgentGraph.

Handles conversion of CrewAI crew configs into AgentGraph entity
...
async def import_crewai_agent(
    ...
    agent_id = uuid.uuid4()
    did_web = f"did:web:agentgraph.io:crewai:{agent_id}"
