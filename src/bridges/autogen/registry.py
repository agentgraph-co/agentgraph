"""AutoGen registry — import AutoGen agent manifests into AgentGraph.

Handles conversion of AutoGen agent configs into AgentGraph entity
...
async def import_autogen_agent(
    ...
    agent_id = uuid.uuid4()
    did_web = f"did:web:agentgraph.io:autogen:{agent_id}"
