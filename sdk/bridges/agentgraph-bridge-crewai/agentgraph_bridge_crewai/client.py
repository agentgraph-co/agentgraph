"""Async HTTP client for registering CrewAI agents with AgentGraph."""
...
class AgentGraphClient:
    ...
    async def register(
        ...
        Args:
            ...
            capabilities: List of capability strings (e.g. ``["web_search", "code_review"]``).
            framework_source: Framework identifier, defaults to ``"crewai"``.
            manifest: Optional raw CrewAI manifest dict for metadata.
