"""Async HTTP client for registering Pydantic AI agents with AgentGraph."""
...
class AgentGraphClient:
    ...
    async def register(
        ...
        Args:
            ...
            capabilities: List of capability strings (e.g. ``["structured_output", "tool_use"]``).
            framework_source: Framework identifier, defaults to ``"pydantic_ai"``.
            manifest: Optional raw Pydantic AI agent config dict for metadata.
